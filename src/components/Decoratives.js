...
import '../css/Decoratives.css'
function Decoratives(){
    let [users,setUsers]=useState([])
    useEffect(()=>{
        const fetchUsers=async()=>{
            let response=await axios.get("http://localhost:8000/Decoratives")
    ...
    return(
        ...
        <div className="row">
        {
            users.map((userObj)=>
                ...
                <div className="card " >
                   <img src={userObj.image} className="card-img-top w-100 imgDecoratives" alt="..." />
